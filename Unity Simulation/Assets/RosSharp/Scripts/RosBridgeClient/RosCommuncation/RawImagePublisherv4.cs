...
Adjustments: New Publication Timing and Execution Framework 
© Siemens AG, 2018, Dr. Martin Bischoff (martin.bischoff@siemens.com)

Adjustments: Concurrent multiple ROS Bridge connections and full ROS2 support
...
{
    public class RawImagePublisherv4 : UnityPublisher<MessageTypes.Sensor.ModifiedCompressedImage>
    {
        ...
        private MessageTypes.Sensor.ModifiedCompressedImage message;
        ...
        public void InitializeMessage()
        {
            ...
            message = new MessageTypes.Sensor.ModifiedCompressedImage();
