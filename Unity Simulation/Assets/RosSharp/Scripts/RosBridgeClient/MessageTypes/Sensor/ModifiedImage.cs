...
{
    public class ModifiedImage : Message
    {
        ...
        public ModifiedImage(ModifiedHeader header, uint height, uint width, string encoding, byte is_bigendian, uint step, byte[] data)
        {
            this.header = header;
            this.height = height;
            this.width = width;
